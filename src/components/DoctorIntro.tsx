    ...
    <div className="py-16 bg-brand-light">
      <div className="container mx-auto px-4">
        ...
        <div className="flex flex-col md:flex-row gap-8">
          {/* Left Column: Doctor Image and Title */}
          <div className="md:w-1/3">
            <div className="heading-primary mb-2 uppercase text-sm tracking-wider font-montserrat">
              Dental Excellence
            </div>
          ...
          {/* Right Column: Doctor Description */}
          <div className="md:w-2/3">
            ...
            <p className="mb-8 text-gray-700 leading-relaxed">
              ...
              <em className="smile-quote">The prettiest thing you can wear is your smile.</em>
            </p>
